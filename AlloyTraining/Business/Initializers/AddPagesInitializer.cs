...
namespace AlloyTraining.Business.Initializers
{
    public class AddPagesInitializer : IBlockingFirstRequestInitializer
    {
        ...
        public AddPagesInitializer(ISiteDefinitionRepository siteRepo, IContentRepository repo)
        {
        ...
        public Task InitializeAsync(HttpContext httpContext)
        {
            ...
            IContent content = repo.GetBySegment(startReference, "about-us", CultureInfo.GetCultureInfo("en"));
            ...
            ContentFolder productsFolder = repo.GetBySegment(ContentReference.GlobalBlockFolder, "Products", CultureInfo.GetCultureInfo("en")) as ContentFolder;

            // create Alloy Meet page
            ProductPage alloyMeet;
            content = repo.GetBySegment(startReference, "alloy-meet", CultureInfo.GetCultureInfo("en"));
            ...
            if (content == null)
            {
                ...
                alloyMeet.PageImage = repo.GetBySegment(productsFolder.ContentLink, "AlloyMeet.png", CultureInfo.GetCultureInfo("en")).ContentLink;
                repo.Save(alloyMeet, SaveAction.Publish, AccessLevel.NoAccess);
            }

            // create Alloy Plan page
            ProductPage alloyPlan;
            content = repo.GetBySegment(startReference, "alloy-plan", CultureInfo.GetCultureInfo("en"));
            ...
            if (content == null)
            {
                ...
                alloyPlan.PageImage = repo.GetBySegment(productsFolder.ContentLink, "AlloyPlan.png", CultureInfo.GetCultureInfo("en")).ContentLink;
                repo.Save(alloyPlan, SaveAction.Publish, AccessLevel.NoAccess);
            }

            // create Alloy Track page
            ProductPage alloyTrack;
            content = repo.GetBySegment(startReference, "alloy-track", CultureInfo.GetCultureInfo("en"));
            ...
            if (content == null)
            {
                ...
                alloyTrack.PageImage = repo.GetBySegment(productsFolder.ContentLink, "AlloyTrack.png", CultureInfo.GetCultureInfo("en")).ContentLink;
